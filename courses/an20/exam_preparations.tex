...
\section{Blatt 12 - Aufgabe 1}

Ermitteln Sie mit Hilfe der Methode der
...
\section{Blatt 12 - Aufgabe 3}

Sei $f \colon \mathbb{R}^2 \to \mathbb{R}$ definiert durch
...
\item Geben Sie eine Darstellung des zugehörigen Restgliedes an.
  ...
  \begin{flalign*}
    ...
    &= \frac{1}{6} e^{\xi_1 + \xi_2} \qty(
      x_1^3 (\xi_1 - \xi_2 + 3) +
      x_1^2x_2 (\xi_1 - \xi_2 + 1) +
      x_1x_2^2 (\xi_1 - \xi_2 - 1) +
      x_2^3 (\xi_1 - \xi_2  - 3)
    )
  \end{flalign*}
\end{enumerate}
...
$M = \qty{(x, y) \in \mathbb{R}^2 \colon y^2 - x^2 = 1}$
ist nicht offen.
\begin{center}
  \begin{tikzpicture}
    \begin{axis}[
